...
*/
type PurlitePoint struct {
	SupportSet   PurliteVPNServiceSupportsSet
...
type PurliteVPNServiceSupportsSet interface {
 ...
 */
func (v *PurlitePoint) RunLoop(prefIPv6 bool) (err error) {
	v.v2rayOP.Lock()
 ...
 */
func (v *PurlitePoint) StopLoop() (err error) {
	v.v2rayOP.Lock()
	defer v.v2rayOP.Unlock()
	if v.IsRunning {
		close(v.closeChan)
...
// Delegate Funcation
func (v PurlitePoint) QueryStats(tag string, direct string) int64 {
...
func (v *PurlitePoint) shutdownInit() {
	v.IsRunning = false
	v.Vpoint.Close()
	v.Vpoint = nil
	v.statsManager = nil
...
func (v *PurlitePoint) pointloop() error {
...
func (v *PurlitePoint) MeasureDelay(url string) (int64, error) {
...
func PurliteOutboundDelay(ConfigureFileContent string, url string) (int64, error) {
...
func NewV2RayPoint(s PurliteVPNServiceSupportsSet, adns bool) *PurlitePoint {
